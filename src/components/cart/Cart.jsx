  ...
  return (
    ...
    >
      ...
      {!cart.length ? (
        ...
        <div>
          <div className=" h-[40dvh] overflow-y-scroll border-b border-zinc-700">
            {cart &&
              cart.map((product) => (
                <CartItem
                  key={product.id}
          ...
          <div className="mb-3 flex h-[12dvh] items-center justify-between border-b border-zinc-700 p-3 text-xl font-semibold">
            <div>Subtotal:</div>
