  ...
  return (
    ...
    >
      ...
      {!cart.length ? (
        ...
        <div>
          <div className=" h-[52vh] overflow-y-scroll bg-slate-900 border-b border-zinc-700">
            {cart &&
              cart.map((product) => (
                <CartItem
                  key={product.id}
          ...
          <div className="mb-3 flex max-h-12 pb-5 items-center justify-between border-b border-zinc-700 px-3 text-xl font-semibold">
            <div>Subtotal:</div>
