...
export default function CategoryBox({
  ...
  return (
    <div>
      <div
        style={boxStyle}
        className={`my-3  flex h-[30vh] w-full flex-col items-start justify-center gap-y-5  bg-blue-500 bg-[url(/images/digital/headphone-1.png)] sm:bg-contain bg-[length:40vw_40vw]  bg bg-right bg-no-repeat uppercase`}
      >
