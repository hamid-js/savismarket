...
function HamburgerMenu({ isOpen, setIsOpen }) {
  ...
  return (
    <div
      ...
      className="fixed  z-50 h-svh w-72 overflow-y-hidden bg-zinc-900 pb-7 duration-700"
    >
      ...
      <ul
        ...
        className="text-lg uppercase *:border-b *:border-zinc-700 *:p-3 last:*:border-none  "
      >
        <li>
