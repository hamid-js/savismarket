...
function LoginPage() {
  ...
  return (
    ...
    >
      <div className="sticky top-0 flex h-28 flex-wrap items-center justify-center bg-[url(/images/bg/bg9.jpg)] bg-cover bg-center  text-center text-xl  uppercase text-gray-100 ">
        <div
          onClick={() => navigate(-1)}
